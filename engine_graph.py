...
def builder(path_spec_file):
	with open(path_spec_file) as f:
		specifications = yaml.load(f)

	# with open(specifications['input_file']) as input_f:
		# input_data = json.load(input_f)
	# print specifications['edges']
	pprint('loading data')
...
if __name__ == "__main__":
	...
	# path_spec_file = 'nodes_2_test.yaml'
	# path_spec_file = 'nodes_3.yaml'
	path_spec_file = 'level5.yaml'
	# path_spec_file = 'level7.yaml'\
	# path_spec_file = 'data3.yaml'
	# path_spec_file = 'ersatz.yaml'
	G = builder(path_spec_file)
